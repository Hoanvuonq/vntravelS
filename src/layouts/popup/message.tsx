    ...
    return (
        <>
            ...
            <div className="fixed inset-0 flex items-center justify-center !z-[120] notes">
                <div
                    ref={popupRef}
                    className="bg-white xl:flex-row flex-col xl:w-[36vw] w-[90vw] xl:h-[10vw] h-[86vw] xl:py-[1.5vw] px-[4vw] xl:rounded-[0.5vw] rounded-[2vw] shadow-custom-4 border border-[#e5e9f2] bai-jamjuree all-center "
                >
